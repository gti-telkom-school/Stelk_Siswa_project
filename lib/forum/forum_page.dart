...
class ForumPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SafeArea(
          child: FutureBuilder<ResFindAll>(builder: (context, snapshot) {
                                  ...
                                  child: Row(
                                    children: [
                                      Padding(
                                        ...
                                        child:
                                            Image.asset('asset/forumrpl.png'),
                                      ),
                                      Container(
                              ...
                              InkWell(
                                    ...
                                    children: [
                                      Padding(
                                        padding:
                                            const EdgeInsets.only(bottom: 15.0),
                                        child:
                                            Image.asset('asset/forumtkj.png'),
                                      ),
                                      Container(
                                          padding: const EdgeInsets.only(
                                              left: 20, bottom: 15),
                                  ...
                                  onTap: () => Navigator.pushNamed(
                                          ...
                                          arguments: {
                                            ...
                                            'judulcaptionguru':
                                                'Apa Saja yang Dipelajari Di Jurusan Teknik Komputer?',
                                            'captionguru':
                                                ' lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a',
                                            'caption1':
                                                'lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a',
                              ...
                              InkWell(
                                    ...
                                    children: [
                                      Padding(
                                        padding:
                                            const EdgeInsets.only(bottom: 15.0),
                                        child:
                                            Image.asset('asset/forumtja.png'),
                                      ),
                                      Container(
                                        padding: const EdgeInsets.only(
                                            left: 20, bottom: 15),
                                  ...
                                  onTap: () => Navigator.pushNamed(
                                          ...
                                          arguments: {
                                            ...
                                            'judulcaptionguru':
                                                'Menjadi Profesional di bidang Teknik Jaringan',
                                            'captionguru':
                                                ' lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a',
                                            'caption1':
                                                'lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a',

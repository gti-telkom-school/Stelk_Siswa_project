...
// import 'package:siswa/home/komentar_page.dart';
...
class RplForumPage extends StatelessWidget {
  const RplForumPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          'Rekayasa Perangkat Lunak', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold),
        ),
        centerTitle: true,
      ),
                      ...
                      InkWell(
                        child: Container(
                          ...
                          child: const CircleAvatar(
                            backgroundImage:
                                AssetImage('asset/suharyunibulat.png'),
                            radius: 25,
                          ),
                        ),

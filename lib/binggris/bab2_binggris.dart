...
class Bab2BinggrisPage extends StatelessWidget {
  final YoutubePlayerController playerController;
  const Bab2BinggrisPage({Key? key, required this.playerController})
      : super(key: key);
            ...
            children: [
              Container(
                ...
                child: const Padding(
                  ...
                  child: Text(
                    'Bab 2 : First Assignment of Suggest and Offer',
